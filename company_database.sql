...
--find forenames andd surnames of all employees
select first_name as forename, last_name as surname from employee

--find out all the diff genders 
...
--find out how many male and females
...
--find a list of employees and branch names and client names
...
--find names of all employees whohave sold over 30000 to a single client 
